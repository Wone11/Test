...
def main():
  ...
  text_summary = '<br/>\n'.join(summary)
  print(text_summary)
  reports.generate("/tmp/cars.pdf", "A Complete Summary of Monthly Car Sales", text_summary, table_data) # type: ignore  
  ...
  message = emails.generate(sender, receiver, subject, body, "/tmp/cars.pdf")  # type: ignore # creates email
  emails.send(message)  # type: ignore
